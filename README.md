...
- **Backends con Python y FastAPI**, autenticación, persistencia y APIs.
...
- Modelos locales mediante **Ollama**, Qwen y Gemma.
- Backend con **FastAPI** y almacenamiento en **SQLite**.
- Biblia Reina-Valera 1909 con **31,084 versículos**.
- RAG bíblico y búsqueda semántica basada en pasajes verificados.
- Agentes especializados, memoria de conversación y orquestación.
- Autenticación JWT, notas, favoritos, exportación a PDF y panel administrativo.
- Capa de seguridad para crisis, abuso y manipulación espiritual.

> Tecnología al servicio de la Palabra. *Soli Deo Gloria.*
...
![Ollama](https://img.shields.io/badge/Ollama-IA_local-000000?style=for-the-badge&logo=ollama&logoColor=white)
...
- Arquitecturas modulares preparadas para evolucionar a productos SaaS.
- Automatizaciones que conectan tecnología, contenido y operaciones.
